...
python3 .Codex/skills/btc-volume-jump-analyzer/scripts/analyze_volume_jump.py --timeframe 6h

# 指定数据文件（带指标的 JSON）
python3 .Codex/skills/btc-volume-jump-analyzer/scripts/analyze_volume_jump.py \
...
```bash
python3 .Codex/skills/btc-momentum-analyzer/scripts/database_manager.py --update --timeframes 6h
```
